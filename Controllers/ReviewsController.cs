...
namespace Camping.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,Rating,UserId,CampSiteId,CreatedOn")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,Rating,UserId,CampSiteId,CreatedOn")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
